...
import com.android.proxymityalert.pushdata.WriteToCSVFile;
...
//					stopSelf();
			...
			case TGDevice.MSG_ATTENTION:
				...
				Log.i("EEG", "Attention:" + mAttention);
			...
			case TGDevice.MSG_MEDITATION:
				...
				Log.i("EEG", "Meditation:" + mMeditation);
		...
		alertBuilder.setTitle(EegUtil.TITLE).setMessage(msg)
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int flag) {
						if (message.equals(EegUtil.CONNECTED_TAG) || message.equals(EegUtil.NOT_FOUND_TAG)) {
